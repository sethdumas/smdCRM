...
<html>
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-container w3-top w3-black w3-large w3-padding" style="z-index:4">
            ...
            <span class="w3-right">smdCRM</span>
        </div>
        ...
        <nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
            ...
            <a href="<c:url value="/" />" class="w3-padding"><i class="fa fa-star"></i>  Menu</a>

            <sec:authorize access="hasRole('ROLE_ADMIN')">
                <div class="w3-dropdown-hover">
                    <a href="<c:url value="/users/viewusers" />" class="w3-padding w3-blue"><i class="fa fa-circle fa-fw"></i>  View Users  <i class="fa fa-caret-down"></i></a>
                    <a href="<c:url value="/users/usersform" />" class="w3-padding w3-blue"><i class="fa fa-circle fa-fw"></i>  Add User  <i class="fa fa-caret-down"></i></a>
                </div>
            </sec:authorize>
            <sec:authorize access="hasRole('ROLE_USER')">
                <div class="w3-dropdown-hover">
                    <a href="<c:url value="/clients/viewclients" />" class="w3-padding w3-blue"><i class="fa fa-circle fa-fw"></i>  View Clients  <i class="fa fa-caret-down"></i></a>
